...
for x in [-3.3,-.7]:
 for y in [.7,2.4]:b('ShelterPost',(x,y,1.25),(.18,.18,2.5),'Wood')
roof=b('Roof',(-2,1.55,2.53),(3.0,2.2,.15),'Roof');roof.rotation_euler.x=.07
b('HayBale',(-2,1.7,.42),(1.10,.83,.78),'Hay',.12)
b('FeedTrough',(2.3,1.9,.32),(1.7,.65,.54),'Wood',.07)
b('Feed',(2.3,1.9,.60),(1.5,.50,.06),'Hay',.02)
b('WaterTrough',(2.4,-1.45,.34),(1.35,.73,.56),'Metal',.09)
b('Water',(2.4,-1.45,.63),(1.16,.54,.03),'Water',.025)
