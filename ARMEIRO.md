...
Resultados esperados: `ARMORY_STATE_OK`, `ARMORY_INTEGRATION_OK`, `SIMULATION: 57 checks, 0 failures` e `V021_STATE_OK`. Capturas ficam em `test-results/armory`; o retrato Blender fica em `test-results/gunsmith`.
