# Como testar a versão 0.6

Este roteiro cobre o **Zeca do Trato** e as **encomendas/vendas da 0.5**.
Abra o executável da pasta `windows-v0.6` e escolha **Voltar para minha fazenda**.
...
4. Para testar salvamento com calma, pause o Zeca, feche a janela, pressione **F5**
   e saia pelo menu. Abra novamente a **0.6**: ele continua contratado e pausado,
